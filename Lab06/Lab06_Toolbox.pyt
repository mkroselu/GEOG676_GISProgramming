...
class RenderTool(object):
    ...
    def execute(self, parameters, messages):
        ...
        if layername == 'GarageParking':
            ...
            # Increment the progressor and change the label; add messages to the results pane 
            ...
            # Increment the progressor and change the label; add message to the result pane 
        ...
        if layername == 'Structures':
            ...
            # Increment the progressor and change the label; add results to the result pane 
            arcpy.SetProgressorPosition(maximum)
            arcpy.SetProgressorLabel("saving project...")
            time.sleep(readTime)
            arcpy.AddMessage("saving project...")
