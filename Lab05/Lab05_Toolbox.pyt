...
class Tool(object):
    def __init__(self):
        ...
        self.label = "Tool"
        self.description = "Finds which buildings on TAMU's campus are near a targeted building."
    ...
    def getParameterInfo(self):
        ...
        param1 = arcpy.Parameter(displayName = "Work GDB name", name = "GDBname", datatype="GPString",parameterType="Required",direction="Input")
        param2 = arcpy.Parameter(displayName = "garage CSV file path", name = "garageCSVfilepath", datatype="DEFile",parameterType="Required",direction="Input")
        param3 = arcpy.Parameter(displayName = "garage name", name = "garagename", datatype="GPString",parameterType="Required",direction="Input")
